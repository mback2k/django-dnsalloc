  ...
  if ($.support.htmlSerialize) {
      ...
      $.ajax({
        ...
        beforeSend: function (XMLHttpRequest, textStatus) {
          if ($(this.owner).find('img')) {
            ...
            $(this.owner).find('img').attr('src', '/images/loading.gif');
          }
        },
        ...
        error: function(XMLHttpRequest, textStatus, errorThrown) {
          if ($(this.owner).find('img')) {
            ...
            $(this.owner).find('img').attr('src', '/icons/exclamation.png');
          } else {
            $(this.owner).attr('title', textStatus);
    ...
    $('form').live('submit', function(event) {
      $.ajax({
        ...
        data: $(this).serialize(),
        beforeSend: function (XMLHttpRequest, textStatus) {
          $(this.owner).find('legend img').attr('src', '/images/loading.gif');
        ...
        error: function(XMLHttpRequest, textStatus, errorThrown) {
          $(this.owner).find('legend img').attr('src', '/images/exclamation.gif');
        }
      });
      event.preventDefault();
      return false;
